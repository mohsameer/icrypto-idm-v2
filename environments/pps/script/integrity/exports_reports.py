...
users_data = None
try:
	postgress_connection = psycopg2.connect(database="midpoint", user='midpoint', password='23rtx28a8w74ctb', host='10.200.120.52', port= '5432')
	...
	cursor.execute("""select
                   ...
                   group by t.oid, t.familyname_norm,t.givenname_norm, t.telephonenumber, t.emailaddress LIMIT 5000""")
...
def generate_csv_from_array(name, dict_array):
	with open("reports/" + name + ".csv", 'w', encoding='utf8', newline='') as output_file:
